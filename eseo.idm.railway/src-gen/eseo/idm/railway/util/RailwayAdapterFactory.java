 ...
 * <!-- end-user-doc -->
 * @see eseo.idm.railway.RailwayPackage
 * @generated
 */
public class RailwayAdapterFactory extends AdapterFactoryImpl {
	...
	protected RailwaySwitch<Adapter> modelSwitch =
		new RailwaySwitch<Adapter>() {
			...
			@Override
			public Adapter caseMetroMap(MetroMap object) {
				return createMetroMapAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link eseo.idm.railway.Station <em>Station</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link eseo.idm.railway.Line <em>Line</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link eseo.idm.railway.MetroMap <em>Metro Map</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMetroMapAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link eseo.idm.railway.Area <em>Area</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
