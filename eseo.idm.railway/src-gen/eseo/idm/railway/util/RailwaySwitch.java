...
public class RailwaySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RailwayPackage.STATION: {
				Station station = (Station)theEObject;
				T result = caseStation(station);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RailwayPackage.LINE: {
				Line line = (Line)theEObject;
				T result = caseLine(line);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RailwayPackage.METRO_MAP: {
				MetroMap metroMap = (MetroMap)theEObject;
				T result = caseMetroMap(metroMap);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RailwayPackage.AREA: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Metro Map</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Metro Map</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMetroMap(MetroMap object) {
		return null;
	}
